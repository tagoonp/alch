          ...
          <div class="row">
            <div class="col-12 text-center pt-5">
              <div class="d-none d-sm-block">
                <h3 style="font-weight: 300 !important; color: rgb(1, 133, 89);">แบบประเมินการตอบสนองและการรู้จำ<br>ต่อผลิตภัณฑ์ที่เกี่ยวข้องกับธุรกิจเครื่องดื่มแอลกอฮอล์</h3>
              </div>
              <div class="d-block d-sm-none">
                <h3 style="font-weight: 300 !important; color: rgb(1, 133, 89);">แบบประเมินการตอบสนองและการรู้จำต่อผลิตภัณฑ์ที่เกี่ยวข้องกับธุรกิจเครื่องดื่มแอลกอฮอล์</h3>
              </div>
            </div>
            <div class="col-12 pt-4">
              <div class="card mb-5">
                <div class="card-body">
                  <h4 class="text-center">คำอธิบาย</h4>
                  <p>
                    <ol>
                      <li>แบบประเมินนี้ แบ่งออกเป็น 4 ส่วน ได้แก่
                        <ul>
                          <li>ข้อมูลส่วนบุคคล</li>
                          <li>พฤติกรรมการดื่มและการรับรู้สื่อ</li>
                          <li>อัตราการตอบสนองต่อการรู้จำ</li>
                          <li>ข้อคำถามและความคิดเห็นอื่น ๆ</li>
                        </ul>
                      </li>
